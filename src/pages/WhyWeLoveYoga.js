  ...
  return (
    <div className={classes.container}>
              ...
              <Typography variant="body2" color="inherit" component="div">
                <ul className={classes.bulletList}>
                  ...
                  <li>
                    ...
                    competitive, so it’s a fabulous form of exercise without the
                    pressure of competition.
                  </li>
                  <li>
                    Increases attention span and improves concentration through
                    our story structure. With our children growing up in this
                    digital era, it is more important than ever to teach our
                    children skills of concentration and perseverance.
                  </li>
                  <li>
      ...
      >
          ...
          >
            ...
            <Grid item>
              ...
              >
                ...
                : A Qualitative Evaluation of Student Learning and Skills Use in
                a School-Based Mindfulness and Yoga Program
              </Typography>
            </Grid>
            <Grid item />
          </Grid>
        ...
        <Grid item className={classes.imgContainer} md={4} xs={12}>
          <img src={coffeeImg} alt="Coffee and Yoga" className={classes.img} />
        </Grid>
      </Grid>
    </div>
  );
